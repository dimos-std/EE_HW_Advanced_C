...
/*
Функция проверяет корректность изменения направления
реализована, но не применяется.
...
Добавлено:
-проверка корректности изменения направления
-прерывание цикла сразу после выполнения условия
*/
